...
\item[(iii)] pour tout $i\geqslant 0$, à l'instant $t_i$, il existe un ensemble séparant $S_i$ et un chemin fermé $c^*_i$ disjoint de $S_i$ tel que $c_i^* \subset (p_i^1\cup p_i^2)$ et $\vert c_i^*\vert \geqslant \frac{1}{2} \vert p_i^1\cup p_i^2 \vert$
\end{itemize}
