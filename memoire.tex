...
Nous disons que $x$ et $y$ sont reliés par un chemin ouvert, noté $\smash{x\underset{\omega}{\longleftrightarrow} y}$, s'il existe un chemin qui relie $x,y$ et toute arête de ce chemin est ouverte dans la configuration $\omega$. Nous notons aussi $x\not\kern-10pt\longleftrightarrow y$ l'événement complémentaire.
