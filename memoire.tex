...
\makeatletter
  ...
  \centering
    ...
    \vfill
       {\LARGE \textbf{Etudes sur l'interface dans le modèle\\
    \vspace{0.5em}
...
Nous énonçons un théorème général sur les chaînes de Markov conditionnées que nous allons utiliser dans la construction de l'interface. Nous faisons référence à \cite{Kelly:2011:RSN:2025239} pour la démonstration.
